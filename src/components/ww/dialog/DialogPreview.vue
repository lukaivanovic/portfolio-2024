    ...
    <div class="relative bg-neutral-100 flex flex-col flex-grow">
      <div class="flex-grow flex items-center justify-center overflow-hidden">
        <template v-if="design == 'one'">
          <div
            class="max-w-[560px] bg-white p-4 rounded-md shadow-sm border border-neutral-200"
          >
            <!-- Product Image -->
            <div class="h-[240px] bg-neutral-100 rounded-lg flex-shrink-0 mb-8">
              <img
                src="/bg.jpg"
            ...
            <!-- Product Details -->
            <div class="flex items-start justify-between gap-12 flex-shrink-0">
              <div>
              ...
              <div class="flex flex-row items-center gap-2">
                <Dialog :content="{ ...PARAMS }" ref="dialogRef">
                  <template #trigger>
                    <button
                      class="trigger relative w-full md:w-auto px-4 py-2 bg-neutral-900 text-white rounded-lg hover:bg-neutral-700 transition-colors text-nowrap"
                    >
                      Add to Cart
                    </button></template
                  >
                    ...
                    >
                      ...
                      <div class="space-y-4 mb-6">
                        ...
                        <div class="flex items-center space-x-4 py-2">
                          <div
                            class="h-16 w-16 bg-neutral-200 rounded-md flex-shrink-0"
                          >
                            <img
                              src="/graphic.png"
                              alt="Premium Wireless Headphones"
                      ...
                      <div class="border-t border-neutral-200 pt-4">
                        ...
                        <div class="flex justify-between text-neutral-700 mb-4">
                          <span>Shipping</span>
                          <span>Free</span>
                        </div>
                        <div
              ...
              <!-- Premium Headphones Information -->
            </div>
          </div>
        </template>
                  ...
                  <div class="py-4 flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-4">
                      <div class="flex items-center">
                        ...
                        <span class="w-8 text-center text-neutral-900">1</span>
                        <button
                          class="w-8 h-8 flex items-center justify-center rounded-md border border-neutral-200 text-neutral-500 hover:bg-neutral-50"
                        >
                          <span>+</span>
                      ...
                      <span class="font-medium text-neutral-900">$299.99</span>
                      <Dialog :content="{ ...PARAMS }" ref="dialogRef">
                        <template #trigger>
                          <button
                  ...
                  <div class="py-4 flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-4">
                      <div class="flex items-center">
                        ...
                        <span class="w-8 text-center text-neutral-900">2</span>
                        <button
                          class="w-8 h-8 flex items-center justify-center rounded-md border border-neutral-200 text-neutral-500 hover:bg-neutral-50"
                        >
                          <span>+</span>
                      ...
                      <span class="font-medium text-neutral-900">$159.98</span>
                      <button
                  ...
                  <Dialog :content="{ ...PARAMS }" ref="dialogRef">
                    ...
                    <template #content>
                      <div
                        ...
                        class="content ww-dialog bg-white p-6 rounded-lg shadow-lg w-[400px]"
                      >
                        <div class="h-48 bg-neutral-100 rounded-lg mb-4"></div>
