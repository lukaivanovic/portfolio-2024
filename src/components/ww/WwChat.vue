      ...
      >
        ...
        <div class="flex flex-col flex-grow">
          ...
          >
            <!-- User Message -->
            <div
              class="flex flex-col bg-neutral-50 p-3 rounded-md border border-neutral-100 body-sm opacity-0"
              ref="userMessage"
            >
                ...
                <div class="flex items-center">
                  ...
                  <div class="relative inline-block h-[14px] w-[160px]">
                    <Transition name="slide-up">
                      ...
                      <span
                        v-else
                        class="absolute ml-2 label-sm content-primary"
                      >
                        Assistant
                      </span>
                    </Transition>
...
const parentContainerWidth = ref(0);
const parentContainerHeight = ref(0);
...
const messages = ref([
  {
    content:
      "I want to create a task management app.I need the ability to create, edit and delete tasks.",
    currentContent: "",
  },
  {
    content:
      "I'll help you a task management app. Let's start by setting up the necessary variables and workflows.",
    currentContent: "",
  },
  {
...
async function runAnimation() {
  ...
  await animate(
    sendButton.value,
    { backgroundColor: "var(--ww-color-bg-inverse)" },
    { duration: 0.2 }
  );
...
function getParentContainerDimensions() {
  if (parentContainer.value) {
    const { width, height } = parentContainer.value.getBoundingClientRect();
    return { width, height };
  }
